...
export const BACKGROUND_JOB_KINDS = [
  ...
  'PLANNING_COVERAGE_PLAN',
  'PLANNING_PROJECT_CANDIDATES',
  'PLANNING_DAY_PLANS',
...
export const BACKGROUND_JOB_KIND_INFO: Record<BackgroundJobKind, BackgroundJobKindInfo> = {
  ...
  PLANNING_COVERAGE_PLAN: { label: 'Coverage plan', route: () => '/planning' },
  PLANNING_PROJECT_CANDIDATES: { label: 'Candidate list', route: () => '/planning' },
  PLANNING_DAY_PLANS: { label: 'Day plans', route: () => '/planning' },
