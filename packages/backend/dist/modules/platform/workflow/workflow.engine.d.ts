...
export declare class WorkflowEngine {
    ...
    executeCommand(workflowKey: string, entityId: string, command: string, fromState: string, toState: string, userId: string, userRole: string, allowedRoles: string[], action: () => Promise<any>, payload?: any): Promise<any>;
