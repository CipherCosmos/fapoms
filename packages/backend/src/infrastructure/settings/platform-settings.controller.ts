...
export class PlatformSettingsController {
   ...
   *
   * Deliberately open to any authenticated user, unlike the rest of this controller: the field
   * app is not staff, and these are the operating rules its user is already subject to — not
   * configuration. Values only, no provenance, no secrets.
   */
  @Get('limits')
