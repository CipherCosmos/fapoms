...
export const en = {
  ...
  selfRegistration: {
    ...
    form: {
      ...
      referencesNote: 'Up to 3 people who can vouch for you — a former employer or colleague. At least one with a phone number is required.',
      ...
      referencesRequired: 'Add at least one reference with a name and phone number.',

      referralTitle: 'Who referred you (optional)',
      referralNote: 'If somebody pointed you to us — one of our assayers, our staff, a bank branch — tell us who, with a mobile or an email.',
    ...
    documents: {
      ...
      badgeNeededToSubmit: 'Needed to submit',
      passbookRequired: 'Upload your bank passbook before submitting — the page with your name, account number and IFSC.',
      ...
      passbookNote: 'The page with your name, account number and IFSC. No passbook? A cancelled cheque or a bank statement’s first page is fine.',
      added: 'Added',
